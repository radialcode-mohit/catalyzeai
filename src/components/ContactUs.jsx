              ...
              <Col lg={6}>
                ...
                <div className="d-flex align-items-center justify-content-between mt-2">
                  <button
                    ...
                    className={
                      first === 0
                        ? "ff_Segoe fw-semibold fs_md clr_green bg-transparent py-2 px-2  border_r_4 border_green px-3"
                        : "ff_Segoe fw-semibold fs_md clr_lgtwhite bg-transparent py-2 px-2 border_1px_white border_r_4 px-3"
                    }
                  >
                    <div
                      onClick={() => {
                  ...
                  <button
                    ...
                    className={
                      first === 1
                        ? "ff_Segoe fw-semibold fs_md clr_green bg-transparent py-2 px-2  border_r_4 border_green px-4"
                        : "ff_Segoe fw-semibold fs_md clr_lgtwhite bg-transparent py-2 px-2 border_1px_white border_r_4 px-4"
                    }
                  >
                    <div
                      onClick={() => {
