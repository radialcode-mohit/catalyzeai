      ...
      <div className="custom_container ">
        <div className="d-flex align-items-center justify-content-between py-4">
          ...
          <ul
            className={
              first
                ? "d-flex align-items-center mb-0 ps-0 small_card_modify flex-column flex-lg-row align-items-center justify-content-center left_minus_100"
                : "d-flex align-items-center mb-0 ps-0 small_card_modify flex-column flex-lg-row align-items-center justify-content-center left_0"
            }
          >
            ...
            <li className="d-flex align-items-center  lihover_a_trans ps-lg-4 ms-lg-5 mt-5 mt-lg-0">
              ...
              <a
                href="#"
                className="clr_black hoevr_underline ff_Segoe fw-semibold fs_md ms-2 clr_white_max"
              >
                Financial Services
              </a>
            </li>
            ...
            <li className="d-lg-none mt-5 mt-lg-0">
              <a
                ...
                className={
                  sign === 1
                    ? "ff_Segoe fw-semibold fs_md clr_green p_10_25 border_green1px border_r_4 "
                    : "ff_Segoe fw-semibold fs_md clr_green  p_10_25 border_1px_white hover_border_green transition border_r_4"
                }
              >
                Sign up
              </a>
            ...
            <li
              ...
              className={
                sign === 2
                  ...
                  : " border_r_4 ms_ 45 border_1px_white ms-lg-3 hover_border_green transition mt-3 d-lg-none mt-5"
              }
            >
              <button className="ff_Segoe fw-semibold fs_md clr_green border-0 bg-transparent p_10_25">
